...
<?php include('includes/header.php') ?>
            ...
            <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <span
                        ...
                        Slide</span>
                    <img src="assects/images/schoolImages/fullschoolA.jpg"
                        class="object-contain block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"
                        alt="...">
                </div>
                <!-- Item 2 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="assects/images/schoolImages/mainschoolA.jpg"
                        class="object-contain block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"
                        alt="...">
                </div>
                <!-- Item 3 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="assects/images/schoolImages/bpschool.jpg"
                        class="object-contain block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"
                        alt="...">
                </div>
            </div>
    ...
    <h1
        ...
        Shree BP Memorial Secondary School</h1>
