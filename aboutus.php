        ...
        <section class="text-gray-600 body-font">
            <div class="container mx-auto flex px-5 py-5 md:flex-row flex-col items-center">
                ...
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                    <img class="object-cover object-center rounded" alt="hero" src="assects/images/joinus/joinusA.jpg">
                </div>
            </div>
        </section>
                    ...
                    <div class="flex flex-col sm:flex-row mt-10">
                        <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
                            <div class="w-20 h-20 rounded-full inline-flex items-center justify-center bg-gray-200 text-gray-400">
                                ...
                                <img src="assects/images/staff/principal.png" alt="" srcset="">

                            </div>
                            <div class="flex flex-col items-center text-center justify-center">
                                <h2 class="font-medium title-font mt-4 text-gray-900 text-lg">Mr. Rom Prasad Regmi</h2>
                                <div class="w-12 h-1 bg-indigo-500 rounded mt-2 mb-4"></div>
                                <p class="text-base">Message From Principal</p>
                                <p class="text-base">Phone no: 9844884641</p>
                            </div>
                        </div>
            ...
            <div class="container px-5 py-24 mx-auto">
                ...
                <div class="grid place-items-center h-screen">
                    <div class="sm:w-1/2 mb-10 px-4">
                        ...
                        <h2 class="title-font text-2xl font-medium text-gray-900 mt-6 mb-3">Study With Us</h2>
                        <p class="text-justify text-sm md:text-base leading-relaxed text-base">
                        <?php echo $row['fifteen'];?></p>
                        <button onclick="joinbtn()" class="flex mx-auto mt-6 text-white bg-indigo-500 border-0 py-2 px-5 focus:outline-none hover:bg-indigo-600 rounded">From 1 to 10</button>
                    </div>
                    <!-- <div class="sm:w-1/2 mb-10 px-4">
                        <div class="rounded-lg h-64 overflow-hidden">
                ...
                <div class="flex flex-wrap -m-4">
                    <div class="xl:w-1/4 md:w-1/2 p-4">
                        <div class="bg-gray-100 p-6 rounded-lg">
                            ...
                            <h2 class="text-lg text-gray-900 font-medium title-font mb-4">Well Equipped Classes</h2>
                    ...
                    <div class="xl:w-1/4 md:w-1/2 p-4">
                        <div class="bg-gray-100 p-6 rounded-lg">
                            ...
                            <h3 class="tracking-widest text-indigo-500 text-xs font-medium title-font"></h3>
                            <h2 class="text-lg text-gray-900 font-medium title-font mb-4">CC TV</h2>
